...
Private Sub Form_Load()
    ...
    PlayPauseImg.Picture = LoadPicture(OfName("PlayPause" & IIf(OneClickGo.mnuPlay.Caption = "&Pause", "A", "L") & "Default"))
End Sub
...
Private Sub NPSfx_Timer() 'Generating Skin effects using a timer
    ...
    If NPS.Width > NPSBlockerR.Left - NPSBlockerL.Width Then
        NPS.Left = IIf(Rotator, NPS.Left + 10, NPS.Left - 10)
...
Private Sub PlayPauseImg_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    Xinit = X
    Yinit = Y
    PlayPauseImg.Picture = LoadPicture(OfName("PlayPause" & IIf(OneClickGo.mnuPlay.Caption = "&Pause", "A", "L") & "Pressed"))
End Sub
