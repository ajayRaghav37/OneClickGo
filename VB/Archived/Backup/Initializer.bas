...
Public cRed As Integer
Public cGreen As Integer
Public cBlue As Integer
...
Sub Main() 'Sub Main is the startup procedure of OneClick Go!
    If App.PrevInstance And GtSt("AllowRun", "0") = "0" Then 'Checking for Previous Instances running in background
        MyMsgBox = MsgBox("OneClick Go! is already running." & Chr$(13) & String(30, "—") & Chr$(13) & "Running multiple sessions simultaneously might result in corruption of your playlist. If you think it's an error, you can feel free to continue with a new session. If you select 'No', we will try to restore the window of your current session." & Chr$(13) & String(30, "—") & Chr$(13) & "Are you sure you want to continue?", vbYesNoCancel + vbExclamation + vbDefaultButton2, "Identical Process Detected")
...
Public Sub DlSt(SettingName As String) 'Procedure to delete setting
...
Public Sub Refresher() 'Procedure to change the interface of SkinnedOCG as soon as the song changes
    ...
    Else
        ...
        SkinnedOCG.Rank.Caption = LTrim$(Str$(NowPlaying + 1))
    End If
...
Public Sub Refresher2() 'Procedure to change the interface of SkinnedOCG2 as soon as the song changes
    ...
    Else
        ...
        SkinnedOCG2.Rank.Caption = "#" & Str$(NowPlaying + 1)
...
Private Sub CheckIntegrity()
    If Not FileSystem.FileExists(App.Path & "\Documents\END USER LICENSE AGREEMENT.rtf") Then
        MyMsgBox = MsgBox("File is missing : END USER LICENSE AGREEMENT.rtf" & Chr$(13) & Chr$(13) & "The file is required to review end user license agreement. It is not a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton1, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    If Not FileSystem.FileExists(App.Path & "\Documents\Help.pdf") Then
        MyMsgBox = MsgBox("File is missing : Help.pdf" & Chr$(13) & Chr$(13) & "The file is required to view help. It is not a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton1, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    If Not FileSystem.FileExists(App.Path & "\Skin\NextPressedPause.BMP") Then
        MyMsgBox = MsgBox("File is missing : NextPressedPause.BMP" & Chr$(13) & Chr$(13) & "The file is required by Freezed Blue Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    If Not FileSystem.FileExists(App.Path & "\Skin\NextPressedPlay.BMP") Then
        MyMsgBox = MsgBox("File is missing : NextPressedPlay.BMP" & Chr$(13) & Chr$(13) & "The file is required by Freezed Blue Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    ...
    If Not FileSystem.FileExists(App.Path & "\Skin\NPSback1.BMP") Then
        MyMsgBox = MsgBox("File is missing : NPSback1.BMP" & Chr$(13) & Chr$(13) & "The file is required by Freezed Blue Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    If Not FileSystem.FileExists(App.Path & "\Skin\NPSback2.BMP") Then
        MyMsgBox = MsgBox("File is missing : NPSback2.BMP" & Chr$(13) & Chr$(13) & "The file is required by Freezed Blue Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    If Not FileSystem.FileExists(App.Path & "\Skin\NPSBlockerL.BMP") Then
        MyMsgBox = MsgBox("File is missing : NPSBlockerL.BMP" & Chr$(13) & Chr$(13) & "The file is required by Rockstar Gold Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    If Not FileSystem.FileExists(App.Path & "\Skin\NPSBlockerR.BMP") Then
        MyMsgBox = MsgBox("File is missing : NPSBlockerR.BMP" & Chr$(13) & Chr$(13) & "The file is required by Rockstar Gold Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    ...
    If Not FileSystem.FileExists(App.Path & "\Skin\PausePressed.BMP") Then
        MyMsgBox = MsgBox("File is missing : PausePressed.BMP" & Chr$(13) & Chr$(13) & "The file is required by Freezed Blue Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    If Not FileSystem.FileExists(App.Path & "\Skin\PlayDefault.BMP") Then
        MyMsgBox = MsgBox("File is missing : PlayDefault.BMP" & Chr$(13) & Chr$(13) & "The file is required by Freezed Blue Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    If Not FileSystem.FileExists(App.Path & "\Skin\PlayPauseADefault.BMP") Then
        MyMsgBox = MsgBox("File is missing : PlayPauseADefault.BMP" & Chr$(13) & Chr$(13) & "The file is required by Rockstar Gold Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    If Not FileSystem.FileExists(App.Path & "\Skin\PlayPauseAPressed.BMP") Then
        MyMsgBox = MsgBox("File is missing : PlayPauseAPressed.BMP" & Chr$(13) & Chr$(13) & "The file is required by Rockstar Gold Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    If Not FileSystem.FileExists(App.Path & "\Skin\PlayPauseLDefault.BMP") Then
        MyMsgBox = MsgBox("File is missing : PlayPauseLDefault.BMP" & Chr$(13) & Chr$(13) & "The file is required by Rockstar Gold Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    If Not FileSystem.FileExists(App.Path & "\Skin\PlayPauseLPressed.BMP") Then
        MyMsgBox = MsgBox("File is missing : PlayPauseLPressed.BMP" & Chr$(13) & Chr$(13) & "The file is required by Rockstar Gold Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    If Not FileSystem.FileExists(App.Path & "\Skin\PlayPressed.BMP") Then
        MyMsgBox = MsgBox("File is missing : PlayPressed.BMP" & Chr$(13) & Chr$(13) & "The file is required by Freezed Blue Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    If Not FileSystem.FileExists(App.Path & "\Skin\PrevNextDefault.BMP") Then
        MyMsgBox = MsgBox("File is missing : PrevNextDefault.BMP" & Chr$(13) & Chr$(13) & "The file is required by Rockstar Gold Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    If Not FileSystem.FileExists(App.Path & "\Skin\PrevNextNPressed.BMP") Then
        MyMsgBox = MsgBox("File is missing : PrevNextNPressed.BMP" & Chr$(13) & Chr$(13) & "The file is required by Rockstar Gold Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    If Not FileSystem.FileExists(App.Path & "\Skin\PrevNextPPressed.BMP") Then
        MyMsgBox = MsgBox("File is missing : PrevNextPPressed.BMP" & Chr$(13) & Chr$(13) & "The file is required by Rockstar Gold Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    ...
    If Not FileSystem.FileExists(App.Path & "\Skin\PrevPressedPlay.BMP") Then
        MyMsgBox = MsgBox("File is missing : PrevPressedPlay.BMP" & Chr$(13) & Chr$(13) & "The file is required by Freezed Blue Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    ...
    If Not FileSystem.FileExists(App.Path & "\Skin\StopPressed.BMP") Then
        MyMsgBox = MsgBox("File is missing : StopPressed.BMP" & Chr$(13) & Chr$(13) & "The file is required by Rockstar Gold Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    If Not FileSystem.FileExists(App.Path & "\Skin\StopPressedPause.BMP") Then
        MyMsgBox = MsgBox("File is missing : StopPressedPause.BMP" & Chr$(13) & Chr$(13) & "The file is required by Freezed Blue Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
    If Not FileSystem.FileExists(App.Path & "\Skin\StopPressedPlay.BMP") Then
        MyMsgBox = MsgBox("File is missing : StopPressedPlay.BMP" & Chr$(13) & Chr$(13) & "The file is required by Freezed Blue Skin. It is a compulsary file" & Chr$(13) & Chr$(13) & "If you want this error to not be displayed each time, copy the original file to (or create a fake file in) " & App.Path & "\Documents" & Chr$(13) & Chr$(13) & "Do you want to continue loading OneClick Go! without this file?", vbCritical + vbYesNo + vbDefaultButton2, "File Not Found")
        If MyMsgBox = vbNo Then
            End
        End If
    End If
