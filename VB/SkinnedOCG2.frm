...
Private Sub NextBtn_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    Yinit = Y
    If OneClickGo.mnuPlay.Caption = "&Pause" Then
        ImgBack.Picture = LoadPicture(OfName("NextPressedPause"))
    Else
        ImgBack.Picture = LoadPicture(OfName("NextPressedPlay"))
    End If
End Sub
...
Private Sub NPSfx_Timer() 'Generate effects in the skin through a timer
    ...
    If NowPlayingSkin.Width > NPSback1.Left - NPSback2.Width Then
        If Rotator Then
            NowPlayingSkin.Left = NowPlayingSkin.Left + 10
        Else
            NowPlayingSkin.Left = NowPlayingSkin.Left - 10
        End If
...
Private Sub PlayBtn_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    Yinit = Y
    If OneClickGo.mnuPlay.Caption = "&Pause" Then
        ImgBack.Picture = LoadPicture(OfName("PausePressed"))
    Else
        ImgBack.Picture = LoadPicture(OfName("PlayPressed"))
    End If
End Sub
...
Private Sub PrevBtn_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    Yinit = Y
    If OneClickGo.mnuPlay.Caption = "&Pause" Then
        ImgBack.Picture = LoadPicture(OfName("PrevPressedPause"))
    Else
        ImgBack.Picture = LoadPicture(OfName("PrevPressedPlay"))
    End If
End Sub
...
Private Sub StopBtn_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    Yinit = Y
    If OneClickGo.mnuPlay.Caption = "&Pause" Then
        ImgBack.Picture = LoadPicture(OfName("StopPressedPause"))
    Else
        ImgBack.Picture = LoadPicture(OfName("StopPressedPlay"))
    End If
End Sub
